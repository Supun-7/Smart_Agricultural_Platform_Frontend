  ...
  return (
    <div className="dashPage">
      ...
      <section className="section">
        <h2 className="sectionTitle">Browse Opportunities</h2>
        <p className="sectionSubtitle">Find projects and invest to create contracts</p>

        <div className="statGrid">
          <StatCard variant="green" kicker="Opportunities" value={String(stats.opportunities)} icon={<IconTrend />} />
          <StatCard variant="plain" kicker="Total Funding Target" valueTop="LKR" value={stats.totalTarget.toLocaleString()} icon={<IconCoin />} />
          <StatCard variant="plain" kicker="Already Funded" valueTop="LKR" value={stats.alreadyFunded.toLocaleString()} icon={<IconCheck />} />
          <StatCard variant="brown" kicker="Avg ROI" value={`${stats.avgRoi.toFixed(1)}%`} sub="Projected returns" icon={<IconPercent />} />
        </div>
      </section>

      <section className="section">
        <h2 className="sectionTitle">Available Projects</h2>
      ...
      >
        ...
        <form className="form" onSubmit={submitInvestment}>
          ...
          <button className="primaryBtn" type="submit">Create contract</button>
        </form>
      </Modal>
    </div>
  );
